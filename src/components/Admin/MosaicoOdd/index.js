                              ...
                              <div>
                                <a onClick={ () => {  
                                  ...
                                  selecionarCorredor(pos[0]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:00`],0,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:00`]; 
                                  selecionarCorredor(pos[1]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:00`],1,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:00`]; 
                                  selecionarCorredor(pos[2]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:00`],2,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                              </div>
                            </td>
                            <td className={ (
                              ...
                              <div>
                                <a onClick={ () => {  
                                  ...
                                  selecionarCorredor(pos[0]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:03`],0,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:03`]; 
                                  selecionarCorredor(pos[1]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:03`],1,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:03`]; 
                                  selecionarCorredor(pos[2]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:03`],2,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                              </div>
                            </td>
                            <td className={ (
                              ...
                              <div>
                                <a onClick={ () => {  
                                  ...
                                  selecionarCorredor(pos[0]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:06`],0,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:06`]; 
                                  selecionarCorredor(pos[1]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:06`],1,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:06`]; 
                                  selecionarCorredor(pos[2]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:06`],2,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                              </div>
                            </td>
                            <td className={ (
                              ...
                              <div>
                                <a onClick={ () => {  
                                  ...
                                  selecionarCorredor(pos[0]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:09`],0,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:09`]; 
                                  selecionarCorredor(pos[1]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:09`],1,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:09`]; 
                                  selecionarCorredor(pos[2]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:09`],2,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                              </div>
                            </td>
                            <td className={ (
                              ...
                              <div>
                                <a onClick={ () => {  
                                  ...
                                  selecionarCorredor(pos[0]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:12`],0,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:12`]; 
                                  selecionarCorredor(pos[1]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:12`],1,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:12`]; 
                                  selecionarCorredor(pos[2]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:12`],2,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                              </div>
                            </td>
                            <td className={ (
                              ...
                              <div>
                                <a onClick={ () => {  
                                  ...
                                  selecionarCorredor(pos[0]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:15`],0,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:15`]; 
                                  selecionarCorredor(pos[1]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:15`],1,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:15`]; 
                                  selecionarCorredor(pos[2]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:15`],2,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                              </div>
                            </td>
                            <td className={ (
                              ...
                              <a onClick={ () => {  
                                  ...
                                  selecionarCorredor(pos[0]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:18`],0,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:18`]; 
                                  selecionarCorredor(pos[1]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:18`],1,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:18`]; 
                                  selecionarCorredor(pos[2]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:18`],2,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                              </div>
                            </td>
                            <td className={ (
                              ...
                              <a onClick={ () => {  
                                  ...
                                  selecionarCorredor(pos[0]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:21`],0,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:21`]; 
                                  selecionarCorredor(pos[1]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:21`],1,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:21`]; 
                                  selecionarCorredor(pos[2]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:21`],2,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                              </div>
                            </td>
                            <td className={ (
                              ...
                              <a onClick={ () => {  
                                  ...
                                  selecionarCorredor(pos[0]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:24`],0,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:24`]; 
                                  selecionarCorredor(pos[1]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:24`],1,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:24`]; 
                                  selecionarCorredor(pos[2]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:24`],2,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                              </div>
                            </td>
                            <td className={ (
                              ...
                              <a onClick={ () => {  
                                  ...
                                  selecionarCorredor(pos[0]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:27`],0,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:27`]; 
                                  selecionarCorredor(pos[1]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:27`],1,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:27`]; 
                                  selecionarCorredor(pos[2]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:27`],2,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                              </div>
                            </td>
                            <td className={ (
                              ...
                              <a onClick={ () => {  
                                  ...
                                  selecionarCorredor(pos[0]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:30`],0,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:30`]; 
                                  selecionarCorredor(pos[1]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:30`],1,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:30`]; 
                                  selecionarCorredor(pos[2]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:30`],2,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                              </div>
                            </td>
                            <td className={ (
                              ...
                              <a onClick={ () => {  
                                  ...
                                  selecionarCorredor(pos[0]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:33`],0,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:33`]; 
                                  selecionarCorredor(pos[1]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:33`],1,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:33`]; 
                                  selecionarCorredor(pos[2]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:33`],2,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                              </div>
                            </td>
                            <td className={ (
                              ...
                              <a onClick={ () => {  
                                  ...
                                  selecionarCorredor(pos[0]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:36`],0,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:36`]; 
                                  selecionarCorredor(pos[1]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:36`],1,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:36`]; 
                                  selecionarCorredor(pos[2]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:36`],2,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                              </div>
                            </td>
                            <td className={ (
                              ...
                              <a onClick={ () => {  
                                  ...
                                  selecionarCorredor(pos[0]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:39`],0,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:39`]; 
                                  selecionarCorredor(pos[1]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:39`],1,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:39`]; 
                                  selecionarCorredor(pos[2]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:39`],2,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                              </div>
                            </td>
                            <td className={ (
                              ...
                              <a onClick={ () => {  
                                  ...
                                  selecionarCorredor(pos[0]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:42`],0,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:42`]; 
                                  selecionarCorredor(pos[1]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:42`],1,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:42`]; 
                                  selecionarCorredor(pos[2]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:42`],2,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                              </div>
                            </td>
                            <td className={ (
                              ...
                              <a onClick={ () => {  
                                  ...
                                  selecionarCorredor(pos[0]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:45`],0,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:45`]; 
                                  selecionarCorredor(pos[1]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:45`],1,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:45`]; 
                                  selecionarCorredor(pos[2]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:45`],2,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                              </div>
                            </td>
                            <td className={ (
                              ...
                              <a onClick={ () => {  
                                  ...
                                  selecionarCorredor(pos[0]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:48`],0,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:48`]; 
                                  selecionarCorredor(pos[1]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:48`],1,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:48`]; 
                                  selecionarCorredor(pos[2]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:48`],2,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                              </div>
                            </td>
                            <td className={ (
                              ...
                              <a onClick={ () => {  
                                  ...
                                  selecionarCorredor(pos[0]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:51`],0,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:51`]; 
                                  selecionarCorredor(pos[1]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:51`],1,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:51`]; 
                                  selecionarCorredor(pos[2]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:51`],2,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                              </div>
                            </td>
                            <td className={ (
                              ...
                              <a onClick={ () => {  
                                  ...
                                  selecionarCorredor(pos[0]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:54`],0,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:54`]; 
                                  selecionarCorredor(pos[1]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:54`],1,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:54`]; 
                                  selecionarCorredor(pos[2]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:54`],2,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                              </div>
                            </td>
                            <td className={ (
                              ...
                              <a onClick={ () => {  
                                  ...
                                  selecionarCorredor(pos[0]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:57`],0,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:57`]; 
                                  selecionarCorredor(pos[1]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:57`],1,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                                <a onClick={ () => {  
                                  let pos = dadosCorridas[`${item}:57`]; 
                                  selecionarCorredor(pos[2]) }}>
                                    {parse(formatMosaicoOddNovo(dadosCorridas[`${item}:57`],2,pos1,pos2,pos3,showNumberOdd, marcados))}</a>
                              </div>
                            </td>
                          </tr>
                        ))}
